               ...
               type : "post",
                ...
                success : function(data){
                    ...
                    if(Object.keys(data).length == 0){
                    	$(".list-group").append("<div class='container'><a href='#' class='list-group-item'><div id='search_data'><table id='table1' border='1'><tr><td>데이터가 없습니다<td></a></div></table></div></td></tr><tr><td>데이터가 없습니다</td></tr>");
